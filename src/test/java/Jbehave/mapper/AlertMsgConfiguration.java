...
import Jbehave.steps.AlertMsgSteps;
...
public class AlertMsgConfiguration extends JUnitStories {

    public AlertMsgConfiguration() {
        super();
        this.configuredEmbedder().candidateSteps().add(new AlertMsgSteps());
    }
    ...
    protected List<String> storyPaths() {
        return Arrays.asList("JBehave/stories/alertMsgStory.story");
    }
}
