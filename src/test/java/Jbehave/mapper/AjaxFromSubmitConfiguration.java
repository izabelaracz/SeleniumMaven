...
import Jbehave.steps.AjaxFromSubmitSteps;
...
public class AjaxFromSubmitConfiguration extends JUnitStories {

    public AjaxFromSubmitConfiguration() {
        super();
        this.configuredEmbedder().candidateSteps().add(new AjaxFromSubmitSteps());
    }
    ...
    protected List<String> storyPaths() {
        return Arrays.asList("JBehave/stories/ajaxFromSubmitStory.story");
    }
}
